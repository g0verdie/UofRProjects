...
to play- the board will first prompt you on which side you wish to play (X or O)- enter the desired side into the command prompt and hit enter. The computer and human players will then take turns, and the current map will be printed out after each move. To make a move, enter the x, y, and z coordinate of the desired move and press enter
